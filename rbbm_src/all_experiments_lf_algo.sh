...
do
	for n in ${optimal_sizes[@]}
		do
			...
			# echo "rand= ${rseed}"
			python main.py -U lf -e experiment_results_folders/all_lf_experiments_1006/3_algo/ -R true -x ${rseed} -X test_cases_seed.txt -T 0 -s ${n} -r 0.5 -G naive -D 0 -l critical \
			-K /home/opc/chenjie/RBBM/rbbm_src/labelling_func_src/src/pickled_funcs_720 -n youtube -k true -P 5432
			echo "python main.py -U lf -e experiment_results_folders/all_lf_experiments_1006/3_algo/ -R true -x ${rseed} -X test_cases_seed.txt -T 0 -s ${n} -r ${c} -G naive -D 0 -l critical \
			...
			python main.py -U lf -e experiment_results_folders/all_lf_experiments_1006/3_algo/ -R true -x ${rseed} -X test_cases_seed.txt -T 0 -s ${n} -r 0.5 -G information_gain -D 0 -l critical \
			-K /home/opc/chenjie/RBBM/rbbm_src/labelling_func_src/src/pickled_funcs_720 -n youtube -k true -P 5432 
			echo "python main.py -U lf -e experiment_results_folders/all_lf_experiments_1006/3_algo/ -R true -x ${rseed} -X test_cases_seed.txt -T 0 -s ${n} -r 0.5 -G information_gain -D 0 -l critical \
			-K /home/opc/chenjie/RBBM/rbbm_src/labelling_func_src/src/pickled_funcs_720 -n youtube -k true -P 5432" >> "$filename"
			global_runs=$(( $global_runs+1 ))
		done
	x=$(( $x+1 ))
...
do
	for n in ${optimal_sizes[@]}
		do
			...
			python main.py -U lf -e experiment_results_folders/all_lf_experiments_1006/3_algo/ -R true -x ${rseed} -X test_cases_seed.txt -T 0 -s ${n} -r 0.5 -G optimal -D 0 -l critical \
			-K /home/opc/chenjie/RBBM/rbbm_src/labelling_func_src/src/pickled_funcs_720 -n youtube -k true -P 5432 
			echo "python main.py -U lf -e experiment_results_folders/all_lf_experiments_1006/3_algo/ -R true -x ${rseed} -X test_cases_seed.txt -T 0 -s ${n} -r 0.5 -G optimal -D 0 -l critical \
			-K /home/opc/chenjie/RBBM/rbbm_src/labelling_func_src/src/pickled_funcs_720 -n youtube -k true -P 5432" >> "$filename"
...
# 							# echo "rand= ${rseed}"
# 							python main.py -U lf -e experiment_results_folders/all_lf_experiments_930/2_algo/ -R true -x ${rseed} -X test_cases_seed.txt -T 0 -s ${n} -r ${c} -G naive -D ${d} -l critical \
# 							-K /home/opc/chenjie/RBBM/rbbm_src/labelling_func_src/src/pickled_funcs_720 -n youtube 
# 							echo "python main.py -U lf -e experiment_results_folders/all_lf_experiments_930/2_algo/ -R true -x ${rseed} -X test_cases_seed.txt -T 0 -s ${n} -r ${c} -G naive -D ${d} -l critical \
# 							-K /home/opc/chenjie/RBBM/rbbm_src/labelling_func_src/src/pickled_funcs_720 -n youtube " >> "$filename"
# 							global_runs=$(( $global_runs+1 ))
# 							python main.py -U lf -e experiment_results_folders/all_lf_experiments_930/2_algo/ -R true -x ${rseed} -X test_cases_seed.txt -T 0 -s ${n} -r ${c} -G information_gain -D ${d} -l critical \
# 							-K /home/opc/chenjie/RBBM/rbbm_src/labelling_func_src/src/pickled_funcs_720 -n youtube 
# 							echo "python main.py -U lf -e experiment_results_folders/all_lf_experiments_930/2_algo/ -R true -x ${rseed} -X test_cases_seed.txt -T 0 -s ${n} -r ${c} -G information_gain -D ${d} -l critical \
# 							-K /home/opc/chenjie/RBBM/rbbm_src/labelling_func_src/src/pickled_funcs_720 -n youtube " >> "$filename"
# 							global_runs=$(( $global_runs+1 ))
# 						done
# 				done
