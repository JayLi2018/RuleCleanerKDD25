...
# 	for n in ${sizes[@]}
# 	do
# 		python main.py -U lf -e experiment_results_folders/experiment_lf_scalability -R true -x 123 -X test_cases_seed.txt -T 0 -s ${n} -r 0.5 -G naive -D 0 -K /home/perm/author/RBBM/rbbm_src/labelling_func_src/src/pickled_funcs_enron -n enron -P 5433
# 		python main.py -U lf -e experiment_results_folders/experiment_lf_scalability -R true -x 123 -X test_cases_seed.txt -T 0 -s ${n} -r 0.5 -G information_gain -D 0 -K /home/perm/author/RBBM/rbbm_src/labelling_func_src/src/pickled_funcs_enron -n enron -P 5433
# 	done
# 	x=$(( $x+1 ))
# done
...
do
  ...
  #                       /home/opc/author/RBBM/rbbm_src/dc_src/user_desired_dcs.txt)
