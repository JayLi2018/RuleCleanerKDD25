...
for d in ${usizes[@]}
# python main.py -e gpt_experiment_results_folders_vary_uq/ -U lf -x 999 --training_model_type majority -X gpt_repeat_seed.txt -T 0 -s 40 -r 0.5 -G information_gain -D 0 --run-gpt-rules --gpt-dataset youtube -n youtube -P 5432

do
python main.py -e gpt_experiment_results_folders_mv/ -U lf -x ${rseed} --training_model_type majority -X gpt_repeat_seed.txt -T 0 -s ${d} -r 0.5 -G information_gain -D 0 --run-gpt-rules --gpt-dataset painter_architect -n painter_architect -P 5432
python main.py -e gpt_experiment_results_folders_mv/ -U lf -x ${rseed} --training_model_type majority -X gpt_repeat_seed.txt -T 0 -s ${d} -r 0.5 -G information_gain -D 0 --run-gpt-rules --gpt-dataset professor_teacher -n professor_teacher -P 5432
python main.py -e gpt_experiment_results_folders_mv/ -U lf -x ${rseed} --training_model_type majority -X gpt_repeat_seed.txt -T 0 -s ${d} -r 0.5 -G information_gain -D 0 --run-gpt-rules --gpt-dataset youtube -n youtube -P 5432
python main.py -e gpt_experiment_results_folders_mv/ -U lf -x ${rseed} --training_model_type majority  -X gpt_repeat_seed.txt -T 0 -s ${d} -r 0.5 -G information_gain -D 0 --run-gpt-rules --gpt-dataset amazon -n amazon -P 5432
